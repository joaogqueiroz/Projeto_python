...
from resource.filtros import normalize_path_params, consulta_com_cidade, consulta_sem_cidade
...
class Hotel(Resource):
    ...
    def post(self, hotel_id):
        ...
        if not SiteModel.find_by_id(dados['site_id']):
            return {"message": "The hotel must be associeted to a valid site ID"}, 400
    ...
    def delete(self, hotel_id):
        ...
        if hotel:
            try:
                hotel.delete_hotel()
            except:{'messege': 'An internal error ocorred trying to delete hotel'}, 500
